...
void LedInit(void)
{
	RCC_APB2PeriphClockCmd(LEDPORTCLK|LEDPORTCLK_1,ENABLE);     //C?p xung CLOCK cho GPIOC va GPIOD
...
void ButtonInit(void)
{
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;          //Input floating do có tr? kéo lên s?n
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;              //Clock GPIO 50Mhz
